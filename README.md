...
<body>
    <header style="background-color: blue;" class="cabecalho">
        <img class="cabecalho-imagem" src="images.webp" alt="logo da alura start">
    ...
    <section class="escola">
        <div class="escola-div-conteudo">
            ...
            <p class="escola-texto-um">A Escola Douglas Weidner Filho foi fundada em 2020 e tem como objetivo ensinar Pensamento Computacional, através do ensino de Informática e  Programação.</p>
        ...
        <img class="escola-imagem" src="images (1).jpeg" alt="imagem que representa uma professora em sala de aula">
    </section>
    <section class="estudante">
        ...
        <div class="estudante-div">
            <img class="estudante-imagem" src="entrete-ratinho.webp" alt="foto do marcelo">
            <h3 class="estudante-nome">Ratinho</h3>
        ...
        <div class="estudante-div">
            <img class="estudante-imagem" src="ator.jpg" alt="foto da gabi">
            <h3 class="estudante-nome">Stallone</h3>
        ...
        <span></span>
        <div class="estudante-div">
            <img class="estudante-imagem" src="jetli.jpeg" alt="foto da rafa">
            <h3 class="estudante-nome">Jet Li</h3>
        ...
        <div class="estudante-div">
            <img class="estudante-imagem" src="download.webp" alt="foto da thais">
            <h3 class="estudante-nome">Gilberto Barros</h3>
    ...
    <footer style="background-color: brown;" class="rodape">
        <img class="rodape-imagem"src="images.webp" alt="logo da alura start">
    </footer>
</body>
</html>
